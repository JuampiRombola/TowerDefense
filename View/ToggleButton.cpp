...
ToggleButton::ToggleButton(int posX, int posY, int width, int height,
                        SDL_Texture *activeTexture, SDL_Texture
                        *inactiveTexture, MousePosition &mousePosition,
                        Renderer &renderer) : Button(posX, posY, width,
                                                    height, inactiveTexture,
                                                    mousePosition,
                                                    renderer),
