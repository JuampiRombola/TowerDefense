...
PickedSpellGTKNotification::PickedSpellGTKNotification(SPELL_TYPE spelltype, bool pick)
        : _spelltype(spelltype), _pick(pick) {

}

PickedSpellGTKNotification::~PickedSpellGTKNotification() {

}
void PickedSpellGTKNotification::Execute(GTKRunner& runner){
